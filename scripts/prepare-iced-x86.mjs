...
const outputDir = join(projectRoot, "public", "vendor", "iced-x86");

rmSync(outputDir, { recursive: true, force: true });
mkdirSync(outputDir, { recursive: true });

cpSync(join(icedX86Dir, "iced_x86_bg.wasm"), join(outputDir, "iced_x86_bg.wasm"));

const nodeEntry = readFileSync(join(icedX86Dir, "iced_x86.js"), "utf8");
const preamble = `// Generated by scripts/prepare-iced-x86.mjs\nconst module = { exports: {} };\n`;
...
const webBootstrap = `const wasmUrl = new URL("iced_x86_bg.wasm", import.meta.url);\n` +
  ...
  `export const MemorySize = module.exports.MemorySize;\n` +
  `export const OpAccess = module.exports.OpAccess;\n` +
  `export const Register = module.exports.Register;\n` +
  ...
  `const InstructionInfoFactoryExport = module.exports.InstructionInfoFactory;\n` +
  ...
  `  InstructionInfoFactoryExport as InstructionInfoFactory,\n` +
...
writeFileSync(join(outputDir, "iced_x86.js"), webEntry, "utf8");
