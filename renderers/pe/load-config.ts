...
export function renderLoadConfig(pe: PeWindowsParseResult, out: string[]): void {
  ...
  out.push(
    renderLoadConfigDefinitionRow("ProcessAffinityMask", formatVa(lc.ProcessAffinityMask), "Preferred processor affinity mask (legacy).")
  );
