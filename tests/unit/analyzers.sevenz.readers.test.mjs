...
import {
  ...
  readUint32Le,
  readUint64Le
} from "../../dist/analyzers/sevenz/readers.js";
...
test("toSafeNumber handles numbers, safe bigints and rejects large bigints", () => {
...
test("readUint32Le and readUint64Le clamp offset and report truncation", () => {
