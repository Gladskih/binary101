...
import { createZipWithBadCdOffset, createZipWithMissingZip64 } from "../fixtures/zip-fixtures.js";

void test("parseZip handles central directory offset beyond file", async () => {
...
void test("parseZip warns when ZIP64 locator is present but record missing", async () => {
