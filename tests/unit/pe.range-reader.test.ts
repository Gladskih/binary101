...
const createTrackedReaderFixture = (
  ...
  reader: ReturnType<typeof createPeRangeReader>;
  requests: number[];
  size: number;
} => {
...
void test("createPeRangeReader reuses a cached window for nearby reads", async () => {
  const tracked = createTrackedReaderFixture("pe-reader-cached-window");
...
void test("createPeRangeReader reuses shifted cached windows with correct relative offsets", async () => {
  const tracked = createTrackedReaderFixture("pe-reader-shifted-window");
...
void test("createPeRangeReader does not reuse a cached window for earlier offsets", async () => {
  const tracked = createTrackedReaderFixture("pe-reader-earlier-offset");
...
void test("createPeRangeReader does not reuse a cached window past its end", async () => {
  const tracked = createTrackedReaderFixture("pe-reader-past-window");
...
void test("createPeRangeReader returns empty views for invalid or empty ranges", async () => {
  const tracked = createTrackedReaderFixture("pe-reader-invalid-ranges");
