...
const CERTIFICATE_PATH_TREE_CERTIFICATE: Parameters<typeof renderAuthenticodeTree>[0] = {
  offset: 0,
  length: 128,
  availableBytes: 128,
  revision: 0x0200,
  ...
  authenticode: {
    format: "pkcs7",
    signers: [{ issuer: "CN=Issuer CA", digestAlgorithmName: "sha256" }],
    certificates: [
      { subject: "CN=Leaf Signer", issuer: "CN=Issuer CA", notBefore: "2024-01-01T00:00:00Z", notAfter: "2026-01-01T00:00:00Z", derBase64: "AQID" },
      { subject: "CN=Issuer CA", issuer: "CN=Root CA", notBefore: "2023-01-01T00:00:00Z", notAfter: "2030-01-01T00:00:00Z" },
      { subject: "CN=Root CA", issuer: "CN=Root CA", notBefore: "2020-01-01T00:00:00Z", notAfter: "2035-01-01T00:00:00Z" },
      { subject: "CN=Timestamp Leaf", issuer: "CN=Timestamp CA", notBefore: "2024-01-01T00:00:00Z", notAfter: "2028-01-01T00:00:00Z" },
      { subject: "CN=Timestamp CA", issuer: "CN=Root CA", notBefore: "2023-01-01T00:00:00Z", notAfter: "2030-01-01T00:00:00Z" }
    ],
    verification: {
      checks: [
        { id: "Signer 1-certificate-1-current-validity", status: "fail", title: "Signer 1: certificate 1 is currently valid", detail: "Current time: 2024-01-01T00:00:00Z -> 2024-02-01T00:00:00Z" },
        { id: "Signer 1-certificate-1-timestamp time-validity", status: "pass", title: "Signer 1: certificate 1 was valid at timestamp time", detail: "2024-01-15T00:00:00Z: 2024-01-01T00:00:00Z -> 2024-02-01T00:00:00Z" },
        { id: "Signer 1 RFC3161 timestamp 1-certificate-1-current-validity", status: "fail", title: "Signer 1 RFC3161 timestamp 1: certificate 1 is currently valid", detail: "Current time: 2024-01-01T00:00:00Z -> 2024-02-01T00:00:00Z" },
        { id: "Signer 1 RFC3161 timestamp 1-certificate-1-timestamp time-validity", status: "pass", title: "Signer 1 RFC3161 timestamp 1: certificate 1 was valid at timestamp time", detail: "2024-01-15T00:00:00Z: 2024-01-01T00:00:00Z -> 2024-02-01T00:00:00Z" }
      ],
      signerVerifications: [{
        index: 0,
        ...
        timestampTokens: [{
          ...
          trustPolicy: {
            ...
            certificates: [
              ...
              { certificateIndex: 1, status: "trusted", sha1Thumbprint: "TSPCA", anchorDerBase64: "CAkK", anchorSha1Thumbprint: "TSROOT", anchorSubject: "CN=Timestamp Trusted Root", stores: ["Root"] }
            ]
          },
          certificates: [
            { subject: "CN=RFC3161 Timestamp Leaf", issuer: "CN=RFC3161 Timestamp CA", notBefore: "2024-01-01T00:00:00Z", notAfter: "2028-01-01T00:00:00Z", derBase64: "BAUG" },
            { subject: "CN=RFC3161 Timestamp CA", issuer: "CN=RFC3161 Timestamp CA", notBefore: "2023-01-01T00:00:00Z", notAfter: "2030-01-01T00:00:00Z" }
          ]
        }]
      }]
    }
...
const TRUST_SNAPSHOT_CERTIFICATE: Parameters<typeof renderAuthenticodeTree>[0] = {
  offset: 0,
  length: 128,
  availableBytes: 128,
  revision: 0x0200,
    ...
    verification: {
      trustPolicy: {
        ...
        certificates: [
          ...
          { certificateIndex: 1, status: "trusted", sha1Thumbprint: "BB", anchorDerBase64: "BAUG", anchorSha1Thumbprint: "DD", anchorSubject: "CN=Trusted Root", stores: ["Root"] },
          { certificateIndex: 2, status: "revoked", sha1Thumbprint: "CC", stores: ["Disallowed"] },
          { certificateIndex: 3, status: "unknown", sha1Thumbprint: "EE" },
          { certificateIndex: 4, status: "unknown", sha1Thumbprint: "FF" },
          { certificateIndex: 5, status: "unknown", sha1Thumbprint: "11" },
          { certificateIndex: 6, status: "trusted", sha1Thumbprint: "22", anchorDerBase64: "CAkK", anchorSha1Thumbprint: "33", anchorSubject: "CN=Trusted Root", stores: ["Root"] }
        ]
      },
      signerVerifications: [
        {
          ...
          countersignatures: [{ index: 0, signerCertificateIndex: 2, certificatePathIndexes: [2] }]
        },
        { index: 1, signerCertificateIndex: 3, certificatePathIndexes: [3, 4] }
      ]
    }
  }
};
...
void test("renderAuthenticodeTree renders signer and countersignature certificate paths", () => {
  const html = renderAuthenticodeTree(CERTIFICATE_PATH_TREE_CERTIFICATE);
...
void test("renderAuthenticodeTree shows Windows CA trust snapshot verdicts", () => {
  const html = renderAuthenticodeTree(TRUST_SNAPSHOT_CERTIFICATE);
