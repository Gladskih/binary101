...
import { parseStreamsInfo, parseSubStreamsInfo } from "../../dist/analyzers/sevenz/streams-info.js";
...
test("parseSubStreamsInfo uses defaults when no entries declared", () => {
...
test("parseStreamsInfo wires pack, unpack and substreams sections", () => {
  // StreamsInfo:
